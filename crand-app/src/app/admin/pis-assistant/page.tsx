    ...
    <div className="flex flex-col min-h-screen pt-20 lg:pt-8 z-0 overflow-hidden bg-gradient-to-br from-emerald-50 to-teal-50">
      <div className="flex-none p-4 sm:p-6 md:p-8">
        ...
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-emerald-800 mb-2">PIS Assistant</h1>
          <p className="text-sm sm:text-base text-emerald-600">Asisten AI untuk membantu Anda dengan informasi pesantren</p>
        </div>
      </div>
