      ...
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-2xl p-4 sm:p-8 sm:mt-12 relative z-0 mt-13">
        ...
        <div className="flex justify-between items-center mb-8">
          <Link
            ...
            className="inline-flex items-center text-blue-800 hover:text-blue-700 transition-colors"
          >
        ...
        {/* Profile Card */}
        <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl p-6 mb-8 shadow-md">
        ...
        <div className="mb-6 border-b border-gray-200" id="tabs">
          <ul className="flex flex-wrap -mb-px text-sm font-medium text-center">
            <li className="mr-2">
              <button
                className="inline-flex p-4 rounded-t-lg text-blue-800 border-b-2 border-blue-800"
              >
