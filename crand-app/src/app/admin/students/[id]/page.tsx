...
export default function StudentDetailPage({ params }: Props) {
  ...
  if (!student) return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-teal-50 pt-20 lg:pt-8">
      <div className="text-center">
        <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-blue-800 mb-4"></div>
        <p className="text-lg text-blue-800 font-medium">Memuat data santri...</p>
      </div>
    </div>
  );

  return (
    <div className="bg-gradient-to-br from-blue-50 to-teal-50 min-h-screen p-3 sm:p-8 pt-20 lg:pt-8">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-2xl p-4 sm:p-8 mb-8 relative z-0">
        {/* Header with back button */}
        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 mb-6">
          <Link
            href="/admin/students"
            className="inline-flex items-center justify-center sm:justify-start text-xs sm:text-sm md:text-base text-blue-800 hover:text-blue-700 transition-colors px-3 py-2 rounded-lg bg-blue-50 border border-blue-100 w-full sm:w-auto"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
            <button
              ...
              className="bg-blue-800 hover:bg-blue-700 text-white font-medium px-3 sm:px-4 py-2 rounded-lg shadow-md transition-all duration-200 flex items-center justify-center gap-2 text-xs sm:text-sm md:text-base w-full sm:w-auto"
            >
            ...
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white font-medium px-3 sm:px-4 py-2 rounded-lg shadow-md transition-all duration-200 flex items-center justify-center gap-2 text-xs sm:text-sm md:text-base w-full sm:w-auto"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        {/* Profile Card */}
        <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl p-4 sm:p-6 mb-8 shadow-md">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="relative">
              <Image
                ...
                width={160}
                height={160}
                className="rounded-full border-4 border-blue-800 shadow-lg object-cover"
              />
              <div className="absolute bottom-2 right-2 bg-blue-800 text-white text-xs font-bold px-2 py-1 rounded-full">
                {student.graduation_status || "Aktif"}
              </div>
            </div>
            <div className="text-center md:text-left flex-1">
              <h2 className="text-xl sm:text-2xl font-bold text-blue-800">{student.name}</h2>
