  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 flex flex-col items-center px-4 py-10">
      <div className="bg-white shadow-2xl rounded-2xl mt-10 p-8 w-full max-w-lg border-t-4 border-emerald-800 mb-8 transition-all duration-300 hover:shadow-emerald-200/50">
        ...
        <AttendanceButton onSuccess={handleAttendanceSuccess} onError={handleAttendanceError} type="admin" isModalOpen={true} />

        <Link href="/manager/attendance/history" className="w-full bg-emerald-800 text-white py-3 px-4 rounded-xl font-semibold hover:bg-emerald-700 transition-all duration-300 mt-6 flex items-center justify-center gap-2 transform hover:scale-[1.02] active:scale-[0.98] shadow-md">
