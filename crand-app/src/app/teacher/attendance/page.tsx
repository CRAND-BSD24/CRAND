                ...
                <Table>
                  ...
                  <TableBody>
                    {scheduleInfo.map((schedule, scheduleIndex) => (
                      <TableRow 
                        key={schedule.day} 
                        className={`hover:bg-emerald-50/70 transition-all duration-200 ${
                          scheduleIndex % 2 === 0 ? 'bg-white' : 'bg-emerald-25'
                        }`}
                      >
                        <TableCell className="font-semibold text-emerald-800 py-6 border-r border-emerald-100">
                          <div className="flex items-center">
                            <div className={`w-3 h-3 rounded-full mr-3 ${
                              schedule.day === 'Minggu' ? 'bg-red-400' : 'bg-emerald-400'
                            }`}></div>
          ...
          <div className="border-t pt-4 flex-shrink-0">
            <div className="flex justify-end">
              <Button
                ...
                className="bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100 px-6 py-2"
              >
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-emerald-50 rounded-lg p-4 mb-4">
            <div className="flex justify-between items-center">
              ...
              <div className="text-sm text-emerald-700 font-medium bg-white px-3 py-1.5 rounded-full border border-emerald-200">
                {format(
          ...
          <div className="mt-4 pr-2">
              ...
              <Table>
                <TableHeader className="sticky top-0 bg-white z-10">
                  <TableRow className="bg-emerald-50">
                    <TableHead className="text-emerald-800 font-semibold">Tanggal</TableHead>
                    <TableHead className="text-emerald-800 font-semibold">Shift</TableHead>
                  ...
                  {loading ? (
                    <TableRow>
                      <TableCell colSpan={3} className="text-center py-8">
                        <div className="flex items-center justify-center text-emerald-700">
                          <div className="w-5 h-5 border-4 border-emerald-200 border-t-emerald-800 rounded-full animate-spin mr-2"></div>
                          Memuat data...
                        </div>
                      </TableCell>
                    </TableRow>
                    ...
                    historyData.map((record) => (
                      <TableRow key={record.id} className="hover:bg-emerald-50/50">
                        ...
                        <TableCell>
                          <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5 text-emerald-600" viewBox="0 0 20 20" fill="currentColor">
                              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                            </svg>
                            {record.shift_time}
                          </div>
            ...
            {/* Weekly Summary */}
            {historyData.length > 0 && (
              <div className="mt-6 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg p-6 border border-emerald-200">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        {dayNames.slice(0, 6).map(day => { // Only show Monday to Saturday
                          ...
                          return (
                            <div key={day} className="bg-white rounded-lg p-3 border border-emerald-100 shadow-sm">
                              <div className="font-semibold text-emerald-800 mb-2 flex items-center">
                              ...
                              <div className="space-y-1 text-sm">
                                {dayData.Hadir > 0 && (
                                  <div className="flex justify-between">
                                    <span className="text-green-700">Hadir</span>
                                    <span className="font-medium text-green-800">{dayData.Hadir}x</span>
                                  </div>
                                )}
                                {dayData.Sakit > 0 && (
                                  <div className="flex justify-between">
                      ...
                      {/* Total Summary */}
                      <div className="bg-white rounded-lg p-4 border-2 border-emerald-300 shadow-md">
                        <div className="flex items-center justify-between">
                          <div>
                            <h5 className="font-bold text-emerald-800 text-lg mb-2 flex items-center">
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                              </svg>
                              Total Mingguan
