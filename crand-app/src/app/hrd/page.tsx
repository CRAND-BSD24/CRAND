    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6 mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-emerald-900">Dashboard HRD</h1>
              <p className="text-emerald-700 text-sm">Ringkasan periode {year}-{pad2(month)}</p>
            </div>
          </div>
      ...
      {/* Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <Link href="/hrd/teachers" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Jumlah Ustadz</CardTitle>
                  <div className="p-2 bg-emerald-700 text-white rounded-lg"><Users className="w-4 h-4" /></div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-emerald-900">{totalTeachers}</div>
                <div className="mt-2 text-emerald-700 text-sm underline">Lihat Detail</div>
              </CardContent>
            </Card>
          </Link>

          {/* Persetujuan Cuti */}
          <Link href="/hrd/teacherEvents" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Persetujuan Cuti</CardTitle>
          ...
          <Link href="/hrd/teacherEvents" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Persetujuan Lembur</CardTitle>
                  <div className="p-2 bg-emerald-700 text-white rounded-lg"><Clock className="w-4 h-4" /></div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-emerald-900">0</div>
          ...
          <Link href="/hrd/teacherContracts" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Persetujuan Pembiayaan</CardTitle>
                  <div className="p-2 bg-green-600 text-white rounded-lg"><Wallet className="w-4 h-4" /></div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-emerald-900">0</div>
          ...
          <Link href="/hrd/attendance" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Check in Tepat Waktu</CardTitle>
          ...
          <Link href="/hrd/attendance" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Terlambat</CardTitle>
          ...
          <Link href="/hrd/attendance" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Belum Check In</CardTitle>
          ...
          <Link href="/hrd/teacherEvents" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Ustadz Cuti Hari Ini</CardTitle>
          ...
          <Link href="/hrd/teacherEvents" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Persetujuan Klaim Kesehatan</CardTitle>
          ...
          <Link href="/hrd/teacherEvents" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Persetujuan Perjalanan Dinas</CardTitle>
          ...
          <Link href="/hrd/teacherContracts" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Kontrak Segera Habis</CardTitle>
                  <div className="p-2 bg-emerald-600 text-white rounded-lg"><FileText className="w-4 h-4" /></div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-emerald-900">0</div>
          ...
          <Link href="/hrd/teacherEvents" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Total Penugasan</CardTitle>
          ...
          <Link href="/hrd/teacherEvents" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Ulang Tahun Bulan Ini</CardTitle>
          ...
          <Link href="/hrd/deleteTeachers" className="block">
            <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-emerald-900">Permintaan Hapus Akun</CardTitle>
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <CardTitle className="text-emerald-900">Total Kehadiran</CardTitle>
                <div className="p-2 bg-blue-600 text-white rounded-lg"><Calendar className="w-4 h-4" /></div>
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-emerald-900">{totalAttendance}</div>
            </CardContent>
          </Card>
          <Card className="group hover:shadow-lg transition-all duration-300 border-none bg-white/80 backdrop-blur-sm hover:bg-white">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <CardTitle className="text-emerald-900">Total Gaji</CardTitle>
                <div className="p-2 bg-amber-500 text-white rounded-lg"><Wallet className="w-4 h-4" /></div>
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-emerald-900">{formatCurrency.format(totalSalary)}</div>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="p-4 overflow-x-auto">
            <Table>
              ...
              <TableBody>
                ...
                {items.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={3} className="text-center py-6 text-emerald-900/70">
