  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 p-6">
      <div className="max-w-4xl mx-auto mt-10 bg-white rounded-2xl shadow-xl p-6 border-t-4 border-emerald-800">
        <h1 className="text-2xl font-bold text-emerald-800">Waktu Libur</h1>
        <p className="text-emerald-700 mt-1 text-sm">Kelola hari libur</p>
        ...
        <div className="mt-6 rounded-xl border border-emerald-100 overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody>
              {items.map((it) => (
                <tr key={it.id || it.date} className="odd:bg-white even:bg-emerald-50/50">
