  ...
  return (
    <main className="min-h-screen">
      ...
      <section id="kontak" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-green-800">Hubungi Kami</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-semibold mb-4 text-green-800">Informasi Kontak</h3>
              <div className="space-y-4">
                <p className="flex items-center text-gray-700">
                  ...
                  Jl. Pesantren No. 123, Kota, Provinsi
                </p>
                <p className="flex items-center text-gray-700">
                  <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h3 className="text-2xl font-semibold mb-4 text-green-800">Kirim Pesan</h3>
