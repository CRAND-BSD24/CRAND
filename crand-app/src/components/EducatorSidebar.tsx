...
import { Home, BookOpen, CalendarCheck, User, Menu, X } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[11px] text-emerald-200/80">Educator Dashboard</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <aside className={cn(
        ...
        <div className="flex flex-col flex-1 px-4 py-6 overflow-y-auto">
          <div className="flex items-center gap-3 px-2 mb-2 mt-6">
            ...
            <div className="flex flex-col">
              <h1 className="text-lg font-bold text-white">CRAND</h1>
              <p className="text-xs text-emerald-200/80">Educator Dashboard</p>
            </div>
          </div>
          ...
          <nav className="mt-2 space-y-2">
            {[
              ...
              { href: '/educator/academic', icon: BookOpen, label: 'Akademik' },
