      ...
      <div className="relative animate-fade-in z-0 w-full max-w-2xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-5 mx-auto relative z-10 transition-all duration-300 hover:shadow-emerald-200/50 border border-emerald-100">
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold text-emerald-800 mb-1 text-center">{profile.name}</h2>
          ...
          <div className="grid grid-cols-2 gap-3 text-xs mb-4">
            <div className="flex items-center p-2 rounded-lg bg-gradient-to-r from-emerald-50 to-emerald-100/40 border border-emerald-100 shadow-sm hover:shadow transition-all duration-200 group">
              ...
              <div className="flex-1">
                <span className="font-medium text-emerald-700 block text-xs">Peran</span>
                <span className="text-emerald-800 font-semibold capitalize block text-sm">{profile.role}</span>
              </div>
            </div>
            ...
            <div className="flex items-center p-2 rounded-lg bg-gradient-to-r from-emerald-50 to-emerald-100/40 border border-emerald-100 shadow-sm hover:shadow transition-all duration-200 group">
              ...
              <div className="flex-1">
                <span className="font-medium text-emerald-700 block text-xs">Nomor Telepon</span>
                <span className="text-gray-800 block text-sm truncate">{profile.phone_number}</span>
              </div>
            </div>
            ...
            <div className="flex items-center p-2 rounded-lg bg-gradient-to-r from-emerald-50 to-emerald-100/40 border border-emerald-100 shadow-sm hover:shadow transition-all duration-200 group col-span-2">
              ...
              <div className="flex-1">
                <span className="font-medium text-emerald-700 block text-xs">Bergabung Sejak</span>
                <span className="text-gray-800 block text-sm">{new Date(profile.created_at).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-5 relative z-10 overflow-hidden">
              ...
              <div className="flex justify-between items-center mb-4 relative z-10">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-600 text-xs">Silakan masukkan password Anda</p>
                  </div>
                </div>
                <button
              ...
              <form onSubmit={handlePasswordSubmit} className="space-y-3">
                <div className="space-y-1 relative z-10">
                  <label className="block text-xs font-medium text-emerald-700">Password Saat Ini</label>
                  <div className="relative">
                ...
                <div className="space-y-1">
                  <label className="block text-xs font-medium text-emerald-700">Password Baru</label>
                  <div className="relative">
                    <input
                ...
                <div className="space-y-1">
                  <label className="block text-xs font-medium text-emerald-700">Konfirmasi Password Baru</label>
                  <div className="relative">
                    <input
