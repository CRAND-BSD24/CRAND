...
import { Home, BookOpen, CalendarCheck, Brain, User, Bot, Menu, Receipt, X } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[11px] text-blue-200/80">Parenting Dashboard</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <aside className={cn(
        ...
        <div className="flex flex-col flex-1 px-4 py-6 overflow-y-auto">
          <div className="flex items-center gap-3 px-2 mb-2 mt-6">
            ...
            <div className="flex flex-col">
              <h1 className="text-lg font-bold text-white">Ibnu Syam</h1>
              <p className="text-xs text-blue-200/80">Parenting Dashboard</p>
            </div>
          </div>
          ...
          <nav className="mt-2 space-y-2">
            {[
              { href: '/parenting', icon: Home, label: 'Dashboard' },
              { href: '/parenting/attendance', icon: CalendarCheck, label: 'Absensi' },
              { href: '/parenting/leaves', icon: BookOpen, label: 'Perizinan' },
              { href: '/parenting/memorization', icon: Brain, label: 'Hafalan' },
              { href: '/parenting/bisyaroh', icon: Receipt, label: 'Bisyaroh' },
              { href: '/parenting/profile', icon: User, label: 'Profil' },
              { href: '/parenting/pis-assistant', icon: Bot, label: 'PIS Assistant' },
...
export default ParentingSidebar;
